...
export const PLANS: Plan[] = [
  {
    ...
    features: [
      ...
      "Integrações: Mercado Pago, Mercado Livre (conectadas) + Shopee, TikTok Shop (em breve)",
...
export const FEATURE_COMPARISON: FeatureComparisonRow[] = [
  ...
  { label: "Integrações (MP, ML → Shopee, TikTok Shop em breve)", free: false, starter: true, pro: true },
