...
// Todas as plataformas já conectam de verdade via OAuth.
const AVAILABLE_PLATFORMS: IntegrationPlatform[] = ["mercado_pago", "mercado_livre", "melhor_envio", "shopee", "tiktok_shop"];
